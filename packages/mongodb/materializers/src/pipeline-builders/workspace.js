...
export class WorkspacePipelineBuilder extends PipelineBuilder {
  constructor() {
  ...
  buildPipeline($match) {
    const stages = [];
    // application
    stages.push(...WorkspacePipelineBuilder.applicationStages());
    // organization
    stages.push(...WorkspacePipelineBuilder.organizationStages());
    // members
    stages.push({
      $lookup: {
